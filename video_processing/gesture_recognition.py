...
class GestureRecognition:
    ...
    def frame_processing(self, frame):
        ...
        if len(landmarks) != 0:
            ...
            if detected_gesture_id == 2:
                ...
                self.processed_points_history = self.get_processed_points_history(self.point_history, w, h)
    ...
    def get_processed_points_history(self, point_history, image_width: int, image_height:int):
