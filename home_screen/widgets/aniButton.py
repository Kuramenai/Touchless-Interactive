from PyQt5.QtCore import QPropertyAnimation, QAbstractAnimation, QEvent
from PyQt5.QtWidgets import QAbstractButton, QRadioButton

class AniAbsractButton(QAbstractButton):
    ...
    def event(self, e):
        if e.type() == QEvent.Show:  #eventID = 17
            self._initStyle(self.__animation.startValue())
        return super().event(e)


class AniRadioButton(QRadioButton, AniAbsractButton):
    def __init__(self):
        super().__init__()
